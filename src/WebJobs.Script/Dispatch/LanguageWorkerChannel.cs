...
namespace Microsoft.Azure.WebJobs.Script.Dispatch
{
    ...
    internal class LanguageWorkerChannel : ILanguageWorkerChannel
    {
        ...
        private IDictionary<string, FunctionRegistrationContext> _registeredFunctions = new Dictionary<string, FunctionRegistrationContext>();
        ...
        public void Register(FunctionRegistrationContext context)
        {
            ...
            _registeredFunctions[context.Metadata.FunctionId] = context;
        ...
        internal void HandleWorkerError(Exception exc)
        {
            ...
            _eventManager.Publish(new WorkerErrorEvent(_workerId, exc));
        }
